...
class DataINgestion:
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        ...
        Description: This method exports data from monogdb to csv file
    ...
    def split_data_as_train_test(self, dataframe: DataFrame) -> None:
        ...
        On Failure : Writr an excpetion log and then raise an exception
        """
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        ...
        try:
            ...
            data_ingestion_artifact = DataIngestionArtifact(trained_file_path= self.data_ingestion_config.trainig_file_path, test_file_path=self.data_ingestion_config.testing_file_path)
